                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<?php echo base_url(); ?>balastestimonial/ubah" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom01">Id Testimonial</label>
                                            <input type="text" class="form-control" id="validationCustom01" name="id_testimonial" value="<?php echo $id_testimonial; ?>" readonly>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom02" name="rating" value="<?php echo $rating; ?>" readonly>

                                        </div>

                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Testimonial</label>
                                            <input type="text" class="form-control" id="validationCustom02" name="pesan_testimonial" value="<?php echo $pesan_testimonial; ?>" readonly>
                                    ...
                                    <a class="btn btn-secondary" href="<?php echo base_url(); ?>datatestimonial">Kembali</a>
                            </div>
                        </div>
