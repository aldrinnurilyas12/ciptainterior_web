...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div style="margin-left: 10px;" class="col-md-8">
                ...
                <form method="POST" action="" class="form-inline">
                    ...
                    <select style="width: 80px;" class="form-control mr-2" name="tahun" ; <?php
                        ...
                        <a class="btn btn-success" href="<?php echo base_url(); ?>datakritiksaran">Refresh</a>
                </form>
            </div>
            <br>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Laporan Data Kritik dan Saran </h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['submit'])) {
                                                ...
                                                $data = $this->db->query("SELECT * FROM kritik_saran where month(tgl_kritiksaran)='$bln'and year(tgl_kritiksaran) = '$tahun' ; ");
                                            } else {
                                                $data = $this->db->query("SELECT * FROM kritik_saran");
                                            }
    ...
    <script>
        $(function() {
            $('#example1').append(
                '<caption style="font-size:0px;caption-side: top;text-align:center;display: table-caption;font-weight:bold;">Laporan data kritik dan saran pelanggan &nbsp;&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Periode :  </caption>'
