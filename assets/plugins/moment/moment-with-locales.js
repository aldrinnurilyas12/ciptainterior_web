;(function (global, factory) {
    ...
    var transInterr = {
        ...
        translate: function (number, withoutSuffix, key) {
            var wordKey = transInterr.words[key];
            if (key.length === 1) {
                ...
                return (
                    number +
                    ' ' +
                    transInterr.correctGrammaticalCase(number, wordKey)
                );
            }
        },
    };
    ...
    hooks.defineLocale('me', {
        ...
        relativeTime: {
            ...
            past: 'prije %s',
            s: 'nekoliko sekundi',
            ss: transInterr.translate,
            m: transInterr.translate,
            mm: transInterr.translate,
            h: transInterr.translate,
            hh: transInterr.translate,
            d: 'dan',
            dd: transInterr.translate,
            M: 'mjesec',
            MM: transInterr.translate,
            y: 'godinu',
            yy: transInterr.translate,
        },
        dayOfMonthOrdinalParse: /\d{1,2}\./,
        ordinal: '%d.',
        week: {
    ...
    var transInterr$1 = {
        ...
        translate: function (number, withoutSuffix, key) {
            var wordKey = transInterr$1.words[key];
            if (key.length === 1) {
                return withoutSuffix ? wordKey[0] : wordKey[1];
            } else {
                return (
                    number +
                    ' ' +
                    transInterr$1.correctGrammaticalCase(number, wordKey)
                );
            }
        },
    };
    ...
    hooks.defineLocale('sr-cyrl', {
        ...
        relativeTime: {
            ...
            past: 'пре %s',
            s: 'неколико секунди',
            ss: transInterr$1.translate,
            m: transInterr$1.translate,
            mm: transInterr$1.translate,
            h: transInterr$1.translate,
            hh: transInterr$1.translate,
            d: 'дан',
            dd: transInterr$1.translate,
            M: 'месец',
            MM: transInterr$1.translate,
            y: 'годину',
            yy: transInterr$1.translate,
        },
        dayOfMonthOrdinalParse: /\d{1,2}\./,
        ordinal: '%d.',
        week: {
    ...
    var transInterr$2 = {
        ...
        translate: function (number, withoutSuffix, key) {
            var wordKey = transInterr$2.words[key];
            if (key.length === 1) {
                return withoutSuffix ? wordKey[0] : wordKey[1];
            } else {
                return (
                    number +
                    ' ' +
                    transInterr$2.correctGrammaticalCase(number, wordKey)
                );
            }
        },
    };
    ...
    hooks.defineLocale('sr', {
        ...
        relativeTime: {
            ...
            past: 'pre %s',
            s: 'nekoliko sekundi',
            ss: transInterr$2.translate,
            m: transInterr$2.translate,
            mm: transInterr$2.translate,
            h: transInterr$2.translate,
            hh: transInterr$2.translate,
            d: 'dan',
            dd: transInterr$2.translate,
            M: 'mesec',
            MM: transInterr$2.translate,
            y: 'godinu',
            yy: transInterr$2.translate,
        },
        dayOfMonthOrdinalParse: /\d{1,2}\./,
        ordinal: '%d.',
        week: {
