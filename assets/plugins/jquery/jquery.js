...
(function (global, factory) {
	...
	function isArrayLike(obj) {
		// Support: real iOS 8.2 only (not reproducible in simuInterr)
	...
	function ajaxExtend(target, src) {
		var key,
			deep,
			fInterptions = jQuery.ajaxSettings.fInterptions || {};

		for (key in src) {
			if (src[key] !== undefined) {
				(fInterptions[key] ? target : deep || (deep = {}))[key] = src[key];
			}
		}
		if (deep) {
	...
	// and CommonJS for browser emuInterrs (#13566)
